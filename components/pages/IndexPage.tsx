      ...
      <div className="max-w-3xl mx-auto px-3 sm:px-4 pb-8">
        ...
        <AnimatedWrapper delay={0.2}>
          <section className="mb-8 ">
            ...
            <div className="space-y-3 text-zinc-300 text-sm sm:text-md leading-relaxed ">
              <p>
        ...
        <AnimatedWrapper delay={0.3}>
          <section className="mb-10 p-4 rounded-xl bg-gradient-to-br from-zinc-900/40 to-zinc-800/20 backdrop-blur-sm border border-zinc-700/40">
        ...
        <AnimatedWrapper delay={0.7}>
          <section className="mb-8">
            ...
            <p className="text-zinc-300 text-sm sm:text-md mb-4 leading-relaxed">
